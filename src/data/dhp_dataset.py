...
import torch
import numpy as np
from data.generators import ChunkedGenerator_Seq2Seq
...
class DHPDataset:
    def __init__(self, data_dir, train=True):
        ...
        self.pos3d, self.pos2d = self.prepare_data(data_dir, train=train)
...
if __name__ == "__main__":
    ...
    gen = ChunkedGenerator_Seq2Seq(64, cameras=None, poses_2d=dataset.pos2d, poses_3d=dataset.pos3d,
